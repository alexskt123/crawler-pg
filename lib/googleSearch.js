...
import { getSpanText } from "./util.js";

export const captureGoogleStockImage = async (stock) => {
  ...
  await searchTextArea.type(`${stock} stock`);
  ...
  console.log(stock, priceText, priceChangeText, priceChangePercentageText);
